...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchProjects() {
        ...
        fetch(`${API_BASE_URL}/api/project/un-publish-projects`)
    ...
    function deleteProject(projectId) {
        ...
        fetch(`${API_BASE_URL}/api/project/delete/${projectId}`, {
            method: 'DELETE',
        })
            .then(response => {
                if (response.ok) {
    ...
    function publishProject(projectId) {
        ...
        fetch(`${API_BASE_URL}/api/project/${projectId}/assign-to-managers`, {
            method: 'POST',
        })
            .then(response => {
                if (response.ok) {
