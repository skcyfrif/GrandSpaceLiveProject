document.addEventListener("DOMContentLoaded", function () {
    ...
    // fetch("http://localhost:9090/api/project/count-dispute-last-year")
        .then(response => {
            if (!response.ok) {
...
async function fetchProjects() {
    try {
        ...
        // const response = await fetch('http://localhost:9090/api/project/dispute-projects-registered-last-year');
