...
public class ManagerController {
	...
	public ResponseEntity<?> addMaterial(@RequestBody MaterialsDTO materialsDTO) {
		try {
			// Add the material and return the response
			Meterials savedMaterial = managerService.addMaterial(materialsDTO);
