					...
					<div class="collapse navbar-collapse justify-content-between">
						...
						<ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown header-profile">
								...
								<div class="dropdown-menu dropdown-menu-end">
									<a href="admin-profile.html" class="dropdown-item ai-icon">
			...
			<div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow ai-icon" href="#">
						...
						<ul aria-expanded="false">
							<li><a href="client_details.html">client_details</a></li>

						</ul>
					</li>
					<li><a class="has-arrow ai-icon" href="calculator.html">
					...
					<li><a class="has-arrow ai-icon" href="#">
						...
						<ul aria-expanded="false">
							<li><a href="project_details.html">project_details</a></li>
							<li><a href="project_materials.html">project_materials</a></li>
						</ul>
					</li>
					<li><a class="has-arrow ai-icon" href="#">
						...
						<ul aria-expanded="false">
							<li><a href="venderEstimates.html">Estimates(vendor)</a></li>
							<li><a href="project_budget.html">Estimates(admin)</a></li>
							<li><a href="client_budget.html">Estimates(client)</a></li>
						</ul>
					</li>
					<li><a class="has-arrow ai-icon" href="#">
							<i class="fa fa-credit-card"></i>
...
document.addEventListener("DOMContentLoaded", function () {
	...
	counters.forEach(counter => {
		const targetValue = parseInt(counter.textContent, 10); // Get target value from text content
		...
		const incrementCounter = () => {
			...
			if (currentValue < targetValue) {
				...
				counter.textContent = targetValue; // Ensure the final value is exact
			}
		};
