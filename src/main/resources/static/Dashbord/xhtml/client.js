	...
	<div id="main-wrapper">
        ...
        ***********************************-->
		<div class="nav-header">
			<a href="client-dashboard.html" class="brand-logo">
				<img class="logo-abbr" src="images/sg_logo.png" alt="/">
			</a>
        ...
        <!-- Rows will be dynamically added here -->
							...
							<li class="nav-item dropdown notification_dropdown">
								...
								<div class="dropdown-menu dropdown-menu-end gs_bel_icon_trop_down">
									<div id="DZ_W_Notification1" class="widget-media dz-scroll p-3">
										<table class="table table-bordered">
													...
													<tr>
														<th>ID</th>
														<th>Date</th>
														<th>How to project work</th>
														<th>Downloads image</th>
													</tr>
													</thead>
													<tbody>
													<tr>
														<td>1</td>
														<td>09-jan-2025</td>
														<td>Building a new website with responsive design a</td>
														<td><a class="btn btn-outline-primary rounded" href="javascript:void(0);">Download Image</a></td>
													</tr>
													<tr>
														<td>1</td>
														<td>09-jan-2025</td>
									...
									<a class="all-notification" href="maneger-project.html">See all notifications <i
							...
							<li class="nav-item dropdown header-profile">
								...
								<div class="dropdown-menu dropdown-menu-end">
									<a href="client-profile.html" class="dropdown-item ai-icon">
		...
		<div class="deznav">
			<div class="deznav-scroll">
				<ul class="metismenu mm-show" id="menu">
					...
					<li><a class="has-arrow ai-icon" href="client-project-details.html" aria-expanded="false">
					...
					<li><a class="has-arrow ai-icon" href="#">
							...
							<span class="nav-text">Project Budget</span>
						</a>
						<ul aria-expanded="false" class="mm-collapse mm-show">
							<li><a href="project-budget.html">Final Budget</a></li>
							<li><a href="project-payment.html">Payment Section</a></li>
					</li>
...
customElements.define('my-client', Client);
...
// Attach the logout function to the button on DOMContentLoaded
