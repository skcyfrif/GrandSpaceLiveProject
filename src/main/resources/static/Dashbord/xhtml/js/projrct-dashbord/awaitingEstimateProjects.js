document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!token) {
        ...
        awaitingEstimateProjects.textContent = "Unauthorized";
        return;
    }
    ...
    .then(data => {
        awaitingEstimateProjects.textContent = data; // Update UI with count
    })
    .catch(error => {
...
async function fetchProjects() {
    ...
    try {
        ...
        projects.forEach(project => {
            ...
            // Estimated by Vendor Date
            const startDateCell = document.createElement("td");
            startDateCell.textContent = project.estimatedByVendor || "Not available";
