document.addEventListener("DOMContentLoaded", function () {
    ...
    const token = sessionStorage.getItem("authToken"); // Change "authToken" if needed

    if (!token) {
        console.error("No token found in sessionStorage. Authorization required.");
        assignedProject.textContent = "Unauthorized";
        return;
    }

    // Fetch the total assigned project count from the API
